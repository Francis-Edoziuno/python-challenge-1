...
while place_order:
    ...
    if menu_selection.isdigit():
        ...
        if int(menu_selection) in menu_items.keys():
            ...
            menu_selection = input(f"which {menu_selection_name} do you want to order? ")
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    if item_quantity.isdigit():
                        ...
                        item_quantity = 1
                        print("You did not enter a number. The quantity will be set to 1.")

                    # Add the item name, price, and quantity to the order list
                    order.append({"item name": menu_selection_name, "price": menu_items[menu_selection]["price"], "Quantity": item_quantity})


                    # Tell the customer that their input isn't valid
                else:
                    print(f"{menu_selection} is not a valid option. Please try again.")
...
for item in order:
    ...
    num_menu_item_name_spaces = 26 - len(menu_item_name)
    num_price_spaces = 8 - len(str(price))
    num_quantity_spaces = 10 - len(str(quantity))


    # 9. Create space strings
    menu_item_name_spaces = ' ' * num_menu_item_name_spaces
    price_spaces = ' ' * num_price_spaces
    quantity_spaces = ' ' * num_quantity_spaces


    # 10. Print the item name, price, and quantity
    print(f"{menu_item_name}{menu_item_name_spaces} {price}{price_spaces} {quantity}{quantity_spaces}")
